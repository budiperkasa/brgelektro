...
class ControllerModulefortuna extends Controller {
    ...
    public function index() {   
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->redirect(HTTPS_SERVER . 'index.php?route=module/fortuna&token=' . $this->session->data['token']);
        }
        ...
        'fortuna_slider',
        'fortuna_skins',
        'fortuna_product_details_layout',
        'fortuna_main_layout',
        'fortuna_product_columns',
        'fortuna_subcat_status',
        'fortuna_subcat_thumbnails_status',
        'fortuna_subcat_thumb_width',
        'fortuna_subcat_thumb_height',
        ...
        'fortuna_menu_color',
        'fortuna_menu_hover',
        'fortuna_dropdown_color',
        'fortuna_dropdown_hover',
        'fortuna_menu_separator',

        'fortuna_cart_total_color',
        'fortuna_cart_total_hover',
        ...
        'fortuna_show_wishlist',
        'fortuna_show_compare',
        'fortuna_show_sale_ribbon',

        'fortuna_categories_menu_color',
        'fortuna_categories_sub_color',
        'fortuna_categories_active_color',
        ...
        'fortuna_title_font',
        'fortuna_title_font_size',
        'fortuna_body_font',
        'fortuna_body_font_size',
        'fortuna_small_font',
        'fortuna_small_font_size',

        'fortuna_featured_carousel',
        'fortuna_bestseller_carousel',
        'fortuna_latest_carousel',
        'fortuna_special_carousel',
        'fortuna_related_carousel',

        'fortuna_carousel_autoplay',

        'fortuna_products_shadows',

        'fortuna_facebook_id',
        'fortuna_facebook_page',
        'fortuna_facebook_icon',
        'fortuna_facebook_button',
        ...
        'fortuna_slider',
        'fortuna_slider_speed',
        'fortuna_slider_transition_time',

        'fortuna_responsive',
        'fortuna_cloud_zoom',
        'fortuna_zoom_position',
        'fortuna_subcat_thumbs',
        'fortuna_logo_position',
        'fortuna_searchbox',
        'fortuna_select_mobile_menu',

        'fortuna_toggle_sidebar',
