						...
						<?php foreach ($products as $product) { ?>
							...
							<div id="wishlist-row<?php echo $product['product_id']; ?>" class="row">
								...
								<div class="col-sm-4 list-actions">
									<input type="button" value="<?php echo $button_cart; ?>" onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button button-cart button-sm" /> 
																			
									<a href="<?php echo $product['remove']; ?>" class="button button-default button-sm" title="<?php echo $button_remove; ?>"><i class="icon-remove-sign"></i> <?php echo $button_remove; ?></a>
								</div>
