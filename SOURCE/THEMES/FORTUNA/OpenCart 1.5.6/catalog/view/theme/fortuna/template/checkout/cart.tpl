<?php echo $header; ?>
	...
	<div class="row">
		...
		<section id="maincontent" class="<?php echo $main; ?> shopping-cart" role="main">
			...
			<div class="mainborder">
				...
				<header class="heading">
					...
					<?php if ($attention) { ?>
					<div class="attention"><?php echo $attention; ?><img src="catalog/view/theme/fortuna/images/close.png" alt="" class="close" /></div>
					<?php } ?>
					<?php if ($success) { ?>
					<div class="success"><?php echo $success; ?><img src="catalog/view/theme/fortuna/images/close.png" alt="" class="close" /></div>
					<?php } ?>
					<?php if ($error_warning) { ?>
					<div class="warning"><?php echo $error_warning; ?><img src="catalog/view/theme/fortuna/images/close.png" alt="" class="close" /></div>
					<?php } ?>
						...
						<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="cart-contents">
							...
							<table class="table table-bordered">
								...
								<tbody>
									...
									<tr>
										<td colspan="5"><i class="icon-rotate-right"></i><strong><?php echo $text_recurring_item ?></strong><br>
									...
									<tr>
										...
										<td class="quantity">
											...
											<a class="update-cart tooltp" title="<?php echo $button_update; ?>" onclick="document.forms['cart-contents'].submit();;" /><i class="icon-repeat"></i></a>
								...
								<tr>
									...
									<td class="quantity">
										...
										<a href="<?php echo $vouchers['remove']; ?>" title="<?php echo $button_remove; ?>" class="tooltp"><i class="icon-remove-sign"></i></a>
									</td>
				...
				<div class="row">
					...
					<section id="cart-module" class="col-sm-6">

						<?php if ($coupon_status || $voucher_status || $reward_status || $shipping_status) { ?>

							<div class="contentset"><?php echo $text_next; ?></div>
							...
							<div class="cart-module">
								...
								<div id="coupon" class="content">
									<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form">
										...
										<input type="submit" value="<?php echo $button_coupon; ?>" class="button button-default button-inverse button-xs" />
									</form>
								</div>
								...
								<div id="voucher" class="content">
									<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form">
										...
										<input type="submit" value="<?php echo $button_voucher; ?>" class="button button-default button-inverse button-xs" />
									</form>
								</div>
								...
								<div id="reward" class="content">
									<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form">
										...
										<input type="submit" value="<?php echo $button_reward; ?>" class="button button-default button-inverse button-xs" />
									</form>
								</div>
								...
								<div id="shipping" class="content form">
									...
									<input type="button" value="<?php echo $button_quote; ?>" id="button-quote" class="button button-default button-inverse button-xs" />
								</div>
					...
					<section id="total-cart" class="col-sm-6">
						...
						<div class="buttons">
							<span class="cart"><a href="<?php echo $checkout; ?>" id="button-checkout" class="button"><?php echo $button_checkout; ?></a></span>
							<a href="<?php echo $continue; ?>" id="continue-shopping" class="button button-default"><?php echo $button_shopping; ?></a>
						</div>
					...
					success: function(json) {
						...
						if (json['error']) {
							if (json['error']['warning']) {
								$('#notification').html('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/fortuna/images/close.png" alt="" class="close" /></div>');
