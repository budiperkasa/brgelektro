<?php echo $header; ?>
	...
	<div class="row">
		...
		<section id="maincontent" class="<?php echo $main; ?> checkout" role="main">
			...
			<div class="mainborder">
				...
				<div class="checkout">
					...
					<section id="checkout" class="checkout_steps">
					...
					<section id="payment-address" class="checkout_steps">
						<header class="checkout-heading">
					...
					<section id="shipping-address" class="checkout_steps">
						<header class="checkout-heading">
					...
					<section id="shipping-method" class="checkout_steps">
						<header class="checkout-heading">
					...
					<section id="payment-method" class="checkout_steps">
						<header class="checkout-heading">
					...
					<section id="confirm" class="checkout_steps">
						<header class="checkout-heading">
	...
	<script type="text/javascript">
		...
		$('.checkout-heading a').live('click', function() {
			...
			$('.checkout_steps').removeClass('section allow active');
			
			$(this).parent().parent().find('.checkout-content').slideDown('slow');
			$(this).closest('.checkout_steps').addClass('section allow active');
	...
	$('#button-account').live('click', function() {
		...
		$.ajax({
			...
			beforeSend: function() {
				...
				$('#button-account').after('<span class="wait">&nbsp;<img src="catalog/view/theme/fortuna/images/loading.gif" alt="" /></span>');
			},		
			complete: function() {
	...
	$('#button-login').live('click', function() {
		...
		$.ajax({
			...
			beforeSend: function() {
				...
				$('#button-login').after('<span class="wait">&nbsp;<img src="catalog/view/theme/fortuna/images/loading.gif" alt="" /></span>');
			},	
			complete: function() {
			...
			success: function(json) {
				...
				if (json['error']) {
					$('#checkout .checkout-content').prepend('<div class="alert warning" style="display: none;">' + json['error']['warning'] + '</div>');
	...
	$('#button-register').live('click', function() {
		...
		$.ajax({
			...
			beforeSend: function() {
				...
				$('#button-register').after('<span class="wait">&nbsp;<img src="catalog/view/theme/fortuna/images/loading.gif" alt="" /></span>');
			},	
			complete: function() {
			...
			success: function(json) {
				...
				if (json['error']) {
					if (json['error']['warning']) {
						$('#payment-address .checkout-content').prepend('<div class="alert warning" style="display: none;">' + json['error']['warning'] + '</div>');
	...
	$('#button-payment-address').live('click', function() {
		$.ajax({
			...
			beforeSend: function() {
				...
				$('#button-payment-address').after('<span class="wait">&nbsp;<img src="catalog/view/theme/fortuna/images/loading.gif" alt="" /></span>');
			},	
			complete: function() {
			...
			success: function(json) {
				...
				if (json['redirect']) {
					...
					if (json['error']['warning']) {
						$('#payment-address .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/fortuna/images/close.png" alt="" class="close" /></div>');
	...
	$('#button-shipping-address').live('click', function() {
		$.ajax({
			...
			beforeSend: function() {
				...
				$('#button-shipping-address').after('<span class="wait">&nbsp;<img src="catalog/view/theme/fortuna/images/loading.gif" alt="" /></span>');
			},	
			complete: function() {
			...
			success: function(json) {
				...
				if (json['redirect']) {
					...
					if (json['error']['warning']) {
						$('#shipping-address .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/fortuna/images/close.png" alt="" class="close" /></div>');
	...
	$('#button-guest').live('click', function() {
		$.ajax({
			...
			beforeSend: function() {
				...
				$('#button-guest').after('<span class="wait">&nbsp;<img src="catalog/view/theme/fortuna/images/loading.gif" alt="" /></span>');
			},	
			complete: function() {
	...
	$('#button-guest-shipping').live('click', function() {
		$.ajax({
			...
			beforeSend: function() {
				...
				$('#button-guest-shipping').after('<span class="wait">&nbsp;<img src="catalog/view/theme/fortuna/images/loading.gif" alt="" /></span>');
			},	
			complete: function() {
	...
	$('#button-shipping-method').live('click', function() {
		...
		$.ajax({
			...
			beforeSend: function() {
				...
				$('#button-shipping-method').after('<span class="wait">&nbsp;<img src="catalog/view/theme/fortuna/images/loading.gif" alt="" /></span>');
			},	
			complete: function() {
			...
			success: function(json) {
				...
				if (json['error']) {
					if (json['error']['warning']) {
						$('#shipping-method .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/fortuna/images/close.png" alt="" class="close" /></div>');
					...
					$.ajax({
						...
						success: function(html) {
							...
							$('.checkout_steps').removeClass('section allow active');
							$('#payment-method').addClass('section allow active');
	...
	$('#button-payment-method').live('click', function() {
		...
		$.ajax({
			...
			beforeSend: function() {
				...
				$('#button-payment-method').after('<span class="wait">&nbsp;<img src="catalog/view/theme/fortuna/images/loading.gif" alt="" /></span>');
			},	
			complete: function() {
			...
			success: function(json) {
				...
				if (json['redirect']) {
					...
					if (json['error']['warning']) {
						$('#payment-method .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/fortuna/images/close.png" alt="" class="close" /></div>');
