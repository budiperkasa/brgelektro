<div class="row">
	...
	<div class="col-sm-6 register">
		...
		<div class="buttons">
			<a id="button-account" class="button button-default button-inverse"><span><?php echo $button_continue; ?></span></a>
		</div>
	...
	<div id="login" class="col-sm-6 login">
		...
		<div class="inner">
			...
			<div class="buttons">
				<input type="button" value="<?php echo $button_login; ?>" id="button-login" class="button button-default button-inverse" />
