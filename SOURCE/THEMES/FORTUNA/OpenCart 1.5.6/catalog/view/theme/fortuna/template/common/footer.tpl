				...
				<div class="row">
					...
					<div class="col-sm-4 follow-us">
						...
						<?php if($this->config->get('fortuna_status') == 1) { ?>
							...
							<?php if(($this->config->get('fortuna_facebook_page') != '') && ($this->config->get('fortuna_facebook_button') == 1)) { ?>
								...
								<div class="fb-container">
									<div id="bg-box" class="fb-like-box" data-href="https://www.facebook.com/<?php echo $this->config->get('fortuna_facebook_page'); ?>" data-width="290" data-height="180" data-color-scheme="light" data-show-faces="true" data-border-color="#FFF" data-stream="false" data-header="false"></div>
								</div>
					...
					<div class="col-sm-3">
						<div class="social">
							<?php if(($this->config->get('fortuna_facebook_page') != '') && ($this->config->get('fortuna_facebook_icon') == 1)) { ?>
									<a href="https://facebook.com/<?php echo $this->config->get('fortuna_facebook_page'); ?>" target="_blank">
							...
							<?php if($this->config->get('fortuna_twitter_username') != '') { ?>
								<a href="https://twitter.com/#!/<?php echo $this->config->get('fortuna_twitter_username'); ?>" target="_blank" title="Twitter" class="tooltp" rel="tooltip" >
								<img src="catalog/view/theme/fortuna/images/icons/twitter.png" alt="Twitter" ></a>
							<?php } ?>
							<?php if($this->config->get('fortuna_youtube_username') != '') { ?>
								<a href="https://youtube.com/user/<?php echo $this->config->get('fortuna_youtube_username'); ?>" target="_blank" title="YouTube" class="tooltp" rel="tooltip" >
								<img src="catalog/view/theme/fortuna/images/icons/youtube.png" alt="YouTube" ></a>
							<?php } ?>
							<?php if($this->config->get('fortuna_gplus_id') != '') { ?>
								<a href="https://plus.google.com/u/0/<?php echo $this->config->get('fortuna_gplus_id'); ?>" target="_blank" title="Google+" class="tooltp" rel="tooltip" >
								<img src="catalog/view/theme/fortuna/images/icons/gplus.png" alt="Google+" ></a>
							<?php } ?>
							<?php if($this->config->get('fortuna_pinterest_id') != '') { ?>
								<a href="https://pinterest.com/<?php echo $this->config->get('fortuna_pinterest_id'); ?>" target="_blank" title="Pinterest" class="tooltp" rel="tooltip" >
							...
							<?php if($this->config->get('fortuna_instagram_username') != '') { ?>
								<a href="https://instagram.com/<?php echo $this->config->get('fortuna_instagram_username'); ?>" target="_blank" title="Instagram" class="tooltp" rel="tooltip" >
							...
							<?php if($this->config->get('fortuna_tumblr_username') != '') { ?>
								<a href="http://<?php echo $this->config->get('fortuna_tumblr_username'); ?>.tumblr.com" target="_blank" title="Tumblr" class="tooltp" rel="tooltip" >
								<img src="catalog/view/theme/fortuna/images/icons/tumblr.png" alt="Tumblr" ></a>
							<?php } ?>
							<?php if($this->config->get('fortuna_skype_username') != '') { ?>
								<a href="skype:<?php echo $this->config->get('fortuna_skype_username'); ?>?call" target="_blank" title="Skype Me!" class="tooltp" rel="tooltip" >
		...
		<footer id="footend">
			...
			<div class="container">
				...
				<?php if($this->config->get('fortuna_status')== 1) { ?>
					...
					<?php } ?>
				<?php } else { ?>
					<div id="copy"><?php echo $this->config->get('config_name'); ?> &copy;2013. Powered by <a class="blue" href="http://www.opencart.com">OpenCart</a><br /><a href="http://www.everthemes.com">Fortuna</a> by <a href="http://www.everthemes.com">EVERTHEMES.COM</a>.</div>
				<?php } ?>
		...
		<?php $js_path="catalog/view/theme/fortuna/js"; ?>
