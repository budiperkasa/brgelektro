...
<?php if($this->config->get('fortuna_status')== 1 && $this->config->get('fortuna_bestseller_carousel') != '') { ?>

	<section id="bestseller-products" class="product-slider top-arrows" <?php if ($this->language->get('direction')=='rtl') echo 'style="direction:ltr;"'?>>
...
<?php } else { ?>
	...
	<section id="bestseller-products" class="box">
