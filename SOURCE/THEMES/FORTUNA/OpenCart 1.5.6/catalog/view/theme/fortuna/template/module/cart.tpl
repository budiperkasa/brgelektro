<section id="cart">
	...
	<div class="cart-total">
		<a href="<?php echo $cart; ?>" title="<?php echo $heading_title; ?>" ><i class="icon-shopping-cart"></i> <span id="cart-total"><?php echo $text_items; ?></span></a>
	</div>
	...
	<div class="details">
		...
		<div class="content">
			...
			<div class="checkout">
				...
				<a href="<?php echo $checkout; ?>" class="button button-default button-cart button-xs"><?php echo $text_checkout; ?></a>
			</div>
