...
<?php if($this->config->get('fortuna_status')== 1 && $this->config->get('fortuna_latest_carousel') != '') { ?>

	<section id="latest-products" class="product-slider top-arrows" <?php if ($this->language->get('direction')=='rtl') echo 'style="direction:ltr;"'?>>
