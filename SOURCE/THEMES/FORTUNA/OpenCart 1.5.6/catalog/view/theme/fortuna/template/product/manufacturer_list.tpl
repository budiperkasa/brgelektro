	...
	<div class="row">
		...
		<section id="maincontent" class="<?php echo $main; ?>" role="main">
			...
			<div class="mainborder">
				...
				<div class="contentset"><?php echo $text_index; ?></div>
				...
				<?php if ($categories) { ?>
					...
					<?php foreach ($categories as $category) { ?>
						...
						<div class="contentset">
							<?php echo $category['name']; ?><a id="<?php echo $category['name']; ?>"></a>
						</div>
								...
								<?php for ($i = 0; $i < count($category['manufacturer']);) { ?>
									...
									<ul class="col-sm-3 unstyled">
										...
										<?php for (; $i < $j; $i++) { ?>
											...
											<li>
												<a href="<?php echo $category['manufacturer'][$i]['href']; ?>"><b><?php echo $category['manufacturer'][$i]['name']; ?></b></a>
											</li>
				...
				<?php } else { ?>
					...
					<div class="content empty">
						...
						<div class="buttons">
							<a href="<?php echo $continue; ?>" class="button button-default button-inverse">
