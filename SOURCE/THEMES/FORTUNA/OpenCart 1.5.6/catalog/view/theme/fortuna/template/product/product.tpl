						...
						<div class="details">
							...
							<div class="row price-cart">
								...
								<div class="cart col-sm-6">
									...
									<div class="add-cart">
										...
										<input type="button" value="<?php echo $button_cart; ?>" id="button-cart" class="button button-default" />
							...
							<div class="row">
											...
											<?php foreach ($options as $option) { ?>
												...
												<?php if ($option['type'] == 'file') { ?>
													...
													<div id="option-<?php echo $option['product_option_id']; ?>" class="form-group">
														...
														<a id="button-option-<?php echo $option['product_option_id']; ?>" class="button button-success button-sm"><i class="icon-upload icon-white"></i> <?php echo $button_upload; ?></a>
								...
								<div class="col-sm-6">
									...
									<span class="wishlist"><a onclick="addToWishList('<?php echo $product_id; ?>');" rel="tooltip" title="<?php echo $button_wishlist; ?>" class="tooltp"><i class="icon-heart"></i></a></span>

									<span class="compare"><a onclick="addToCompare('<?php echo $product_id; ?>');" rel="tooltip" title="<?php echo $button_compare; ?>" class="tooltp"><i class="icon-plus"></i></a></span>
									...
									<div class="panel-body">
										...
										<section id="add-review">
											...
											<div id="review-form" class="form">
												...
												<div class="contentset center" id="review-title"><?php echo $text_write; ?></div>
												...
												<div class="form-actions buttons">
													<a id="button-review" class="button button-default button-inverse"><span><?php echo $button_continue; ?></span></a>
												</div>
